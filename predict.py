...
cleaned_data = "heart_cleaned_2.h5"
...
def show_predict_page():
	...
	diffwalk = st.radio(" Do you have serious difficulty walking or climbing stairs? ", diffwalks)
	new_entry.iloc[0].DIFFWALK = diffwalks.index(diffwalk) + 1
	...
	cvdstrk3 = st.radio("Have you ever been told by a healthcare professional that you had a stroke?", cvdstrk3s)
	new_entry.iloc[0].CVDINFR4 = cvdstrk3s.index(cvdstrk3) + 1
	...
	pneuvac4 = st.radio("Have you ever had a pneumonia shot also known as a pneumococcal vaccine? ", pneuvac4s)
	new_entry.iloc[0].PNEUVAC4 =  pneuvac4s.index(pneuvac4) + 1
	...
	if clicked:
		...
		if pct > 30:
			st.markdown(f"""
<a href={click_url}><button>Click to find a heart surgeon near you!</button></a>
""")
